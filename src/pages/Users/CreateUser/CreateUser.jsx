...
const CreateUser = () => {
    ...
    const [firstName, setFirstName] = useState(
        location.state ? location.state.first_name : ""
    );
    const [lastName, setLastName] = useState(
        location.state ? location.state.last_name : ""
    );
    ...
    const [date, setDate] = useState(
        location.state ? location.state.confirmed_at : newDate.toISOString()
    );
    const [isActive, setIsActive] = useState(
        location.state ? location.state.is_enabled : false
    );
    const [isEmail, setIsEmail] = useState(
        location.state ? location.state.send_tracking_emails_by_default : false
    );
